# Caja Facil puente de conexión POS
...
`Caja Facil puente de conexión POS` es una aplicación de escritorio que permite conectar nuestro `Verificador de Precios` con el punto de venta `Caja Fácil®`.

<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781229031/assets/proyecto-verificador-precios/bridge-libp2p/cajafacil/cajafacil-home.png?v=1" width="720" alt="Vista general del panel principal del puente de conexión POS">
</p>
...
1. Instale `Caja Facil puente de conexión POS` y permita las `conexiones entrantes` cuando `Windows` lo solicite.
2. Abra la aplicación y revise la [conexión al punto de venta](#conexión-al-punto-de-venta).
3. Confirme la carpeta de instalación de `Caja Fácil®` y verifique los valores predeterminados de conexión.
4. Compruebe que la aplicación logre conectarse correctamente al punto de venta.
...
## Compatibilidad con punto de venta `Caja Fácil®`

- `CajaFacil®` versión `3.2`

## Descarga segura

Antes de instalar la aplicación, tenga en cuenta lo siguiente:

- `Caja Facil puente de conexión POS` es software legítimo y distribuido de forma oficial a través de [nuestro repositorio de GitHub](https://github.com/verificador-precios).
...
1. Descargue [la última versión del instalador](https://github.com/verificador-precios/puente-de-conexion-pos-cajafacil/releases/latest).
2. Abra el archivo descargado.
3. Siga los pasos del asistente de instalación.
4. Al finalizar, abra `Caja Facil puente de conexión POS`.
...
Después de instalar y abrir la aplicación, `Windows` puede mostrar una alerta del firewall indicando que `Caja Facil puente de conexión POS` desea comunicarse en la red. Este permiso es necesario para que la aplicación pueda recibir conexiones locales y funcionar correctamente.

Si aparece esta ventana:

1. Verifique que la aplicación corresponda a `Caja Facil puente de conexión POS`.
...
4. Busque `Caja Facil puente de conexión POS` en la lista.
...
2. Entre a `Firewall y protección de red`.
3. Haga clic en `Permitir una aplicación a través del firewall`.
4. Busque `Caja Facil puente de conexión POS`.
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781224554/assets/proyecto-verificador-precios/bridge-libp2p/wincaja/wincaja-update-install-content.png?v=1" width="420" alt="Ejemplo del aviso de actualización lista en el puente de conexión POS">
</p>
...
Si necesita actualizar manualmente, descargue e instale la versión más reciente publicada para `Caja Facil puente de conexión POS`.
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781228538/assets/proyecto-verificador-precios/bridge-libp2p/cajafacil/cajafacil-app-config.png?v=1" width="720" alt="Ejemplo de la pantalla de configuración de la aplicación en Caja Facil puente de conexión POS">
</p>
...
La aplicación está preparada para conectarse al punto de venta `Caja Fácil®`.

### Credenciales predeterminadas usadas por la aplicación
...
4. Confirme que el `Puerto` sea `3310`.
5. Confirme que el `Usuario` sea `ODBC`.
6. Confirme que el `Nombre de la base de datos` sea `rpv`.
7. Compruebe la conexión.

<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781228539/assets/proyecto-verificador-precios/bridge-libp2p/cajafacil/cajafacil-db-config-form.png?v=1" width="520" alt="Ejemplo del formulario de conexión del puente de conexión POS">
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781228540/assets/proyecto-verificador-precios/bridge-libp2p/cajafacil/cajafacil-home-server-connection-url.png?v=1" width="520" alt="Ejemplo de la URL para conexión del servidor mostrada en la aplicación">
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781228542/assets/proyecto-verificador-precios/bridge-libp2p/cajafacil/cajafacil-url-assistant-content.png?v=1" width="520" alt="Ejemplo del Asistente de URL de acceso para configurar Verificador de Precios">
</p>
...
- `https://cajafacil.verificador-precios-prueba.com.mx/`
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781156523/assets/proyecto-verificador-precios/bridge-libp2p/wincaja/wincaja-home-access-assistant.png?v=1" width="520" alt="Ejemplo de los botones Copiar y Abrir después de registrar la URL del Verificador de Precios">
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781231409/assets/proyecto-verificador-precios/screenshots/direct-pos-database/cajafacil-verificador-precios-prueba-com-mx-config-data-source-0cdf16e4f1.jpg?v=1" width="720" alt="Opciones de conexión rápida por QR en Verificador de Precios">
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/xadani-mexico/image/upload/v1781231410/assets/proyecto-verificador-precios/screenshots/direct-pos-database/cajafacil-verificador-precios-prueba-com-mx-config-data-source-b03df0249a.jpg?v=1" width="720" alt="Ejemplo de Verificador de Precios con la conexión establecida correctamente">
</p>
...
3. Busque `Caja Facil puente de conexión POS`.
